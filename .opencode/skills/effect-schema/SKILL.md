...
This repo tests with `alchemy@2.0.0-beta.63` and `effect@4.0.0-beta.97`, while accepting stable Effect 4 through the peer dependency range.
...
- `@alchemy` for Alchemy v2 provider/resource integration details.
