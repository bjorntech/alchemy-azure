...
- Dependency compatibility with `alchemy@2.0.0-beta.57` and `effect@4.0.0-beta.84`.
...
Use `@alchemy-effect` for upstream Alchemy v2 provider APIs, `Resource` / `Provider.effect` patterns, `Platform` behavior, and compatibility checks.
